...
debug:
	...
	cp -R /usr/local/Cellar/qt/5.15.2/plugins dist/Mkchromecast.app/Contents/PlugIns
	/usr/local/Cellar/qt/5.15.2/bin/macdeployqt dist/Mkchromecast.app
...
deploy:
	...
	python3 setup.py py2app
	cp -R /usr/local/Cellar/qt/5.15.2/plugins dist/Mkchromecast.app/Contents/PlugIns
	/usr/local/Cellar/qt/5.15.2/bin/macdeployqt dist/Mkchromecast.app -dmg
